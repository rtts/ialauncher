...
def main():
    ...
    parser.add_argument('--slurp-mode', dest='slurp_mode', action='store_true', help='Slurp mode: downloads ALL games from the Internet Archive, one by one. This will take days or even weeks to finish. Please don’t do this for no reason -- the Internet Archive has limited bandwith.')
